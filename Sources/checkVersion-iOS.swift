...
//    static let appStoreId = APPID // Id Example
    public var appStoreId = ""
    // MARK: - Show Update Function
    public func showUpdate(withConfirmation: Bool, isTestFlight: Bool = false, appID: String) {
    ...
    private func getUrl(from identifier: String) -> String {
        ...
        let countryCode = Locale.current.regionCode ?? "US"  // Default to "US" if not available

        let appStoreURL = "http://itunes.apple.com/\(countryCode)/lookup?bundleId=\(identifier)"
...
//        guard let appName = CheckUpdate.shared.getBundle(key: "CFBundleName") else { return }
        ...
        guard let appName = CheckUpdate.shared.getBundle(key: "CFBundleDisplayName") ??

                            CheckUpdate.shared.getBundle(key: "CFBundleName") else {
        ...
        let updateButton = UIAlertAction(title: "Update", style: .default) { (action:UIAlertAction) in
            ...
            self.openAppStorePageInApp(appId: CheckUpdate.shared.appStoreId)
...
//        alertController.preferredAction = updateButton  // Highlight button
//
//        alertController.view.isUserInteractionEnabled = false
//            DispatchQueue.main.asyncAfter(deadline: .now() + 0.1) {
//                alertController.view.isUserInteractionEnabled = true
//            }
//
//            // Present alert
...
//            }
    ...
    func openAppStorePageInApp(appId: String) {
